...
export function WorkflowMetaPanel({ workflow, copyText }: WorkflowMetaPanelProps) {
  return (
    <aside className="space-y-4 lg:sticky lg:top-24">
      <Card className="p-5">
        <h2 className="text-lg font-semibold text-zinc-950">Quick check</h2>
        <dl className="mt-4 divide-y divide-zinc-100 text-sm">
          <div>
            <dt className="font-medium text-zinc-950">Tested</dt>
      ...
      <Card className="p-5">
        <h2 className="text-lg font-semibold text-zinc-950">Use this carefully</h2>
